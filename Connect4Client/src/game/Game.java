...
public class Game extends javax.swing.JFrame {
    ...
    public Game() {
        ...
        try {
            ...
            icons_right[0] = new ImageIcon(new ImageIcon(ImageIO.read(this.getClass().getClassLoader().getResource("images/tas_right.png")))
              .getImage().getScaledInstance(lbl_gamer1.getWidth(), lbl_gamer1.getHeight(), Image.SCALE_DEFAULT));
                    ...
                    if (RivalSelection == -1 || myselection == -1) {
                       ...
                       //          tas                makas
                        if (myselection == 0 && RivalSelection == 2) {
                            lbl_gamer1.setIcon(icons[2]);//win
                            lbl_gamer2.setIcon(icons[1]);//lose
